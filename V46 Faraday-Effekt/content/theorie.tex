...
\begin{equation}
  ...
  \end{array} } \right]\,.
\end{equation}
Während bei $\chi$ sich in vielen Fällen diagonalisieren lässt, treten für doppeltbrechende Materialien nicht-diagonale Elemente auf, welche komplex konjugiert zueinander sind.
\begin{equation}
  \chi=
  \left[ {\begin{array}{ccc}
