...
Mit den maximal gemessenen magnetischen Feldstärken für die erste Resonanzstelle von $B=\SI{1088,78}{µT}$ und $B=\SI{1096,37}{µT}$ für die zweite, ergibt sich mit $m_F=3$ für \ce{^{85}Rb} und $m_F=2$ für \ce{^{87}Rb} und der entsprechenden Hyperfeinstrukturaufspaltung aus Formel \eqref{eq:thermisch}:
\begin{align*}
