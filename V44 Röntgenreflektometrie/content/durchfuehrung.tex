...
\includegraphics[width=0.85\textwidth]{bilder/detektor.png}\\
\centering{a)}
\includegraphics[width=0.85\textwidth]{bilder/zscan.png}
\centering{b)}
\end{minipage}
\begin{minipage}[c]{0.45\textwidth}
\includegraphics[width=0.85\textwidth]{bilder/rocking.png}
\centering{c)}
\end{minipage}
